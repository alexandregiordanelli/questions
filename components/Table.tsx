...
export const TableNotebooks: React.FC<{
  ...
  const [notebookSelected, setNotebookSelected] = useState<Notebook>(null)
      ...
      {isOpened && (
        <Modal showModal={setIsOpened}>
          ...
          <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button
              type="button"
              onClick={async () => await deleteClient([props.customerTag, notebookSelected.tag])}
