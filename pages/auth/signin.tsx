    ...
    return (
        <FormEmail csrfToken={props.csrfToken} cursorPosition={cursorPosition}>
            <label className="w-full">
                ...
                <input type="text" className="p-2 text-base w-full rounded text-gray-900" name="email" onKeyDown={x => {
            ...
            <button type="submit" className="bg-green-600 text-white rounded-md mt-4 px-4 py-2 cursor-pointer w-full">Send Magic Link to Email</button>
        </FormEmail>
    );
}
