        ...
        <div className="container">
          <div className="flex">
            <div className="texts">
              ...
              <p>
                Nós já organizamos, filtramos e escolhemos as principais questões para você ter
                exito!
              </p>
            </div>
          ...
          <div className="flex2">
            {props.notebooks.map((x, i) => (
              <div key={i} className="box">
                ...
                <p>
                  Utility-centric and BEM-style components to give you the building blocks for any
                  web project.
                </p>
              </div>
            ))}
